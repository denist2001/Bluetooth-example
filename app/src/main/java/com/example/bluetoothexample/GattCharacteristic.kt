...
import com.example.bluetoothexample.UuidUtils.parseIntFromUuidStart
import java.util.*
...
enum class GattCharacteristic {
    ...
    BloodPressure("0000fff0-0000-1000-8000-00805f9b34fb", "custom.type", BluetoothGattCharacteristic.FORMAT_UINT32),
//
